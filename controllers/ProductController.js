...
// export const generatecloudinaryUrl = async (req, res) => {
//   try {
//     const products = await ProductModel.find();
//     for (const product of products) {

//       const cloudinaryName = product.name.split(" ").join("-");

//       await ProductModel.updateOne(
//         { _id: product._id },
//         { $set: { cloudinaryUrl: 'https://res.cloudinary.com/dlsaa67yx/image/upload/v1707765768/' + cloudinaryName } }
//       );
//     }

//     res.json("Все продукты обновлены успешно.");
